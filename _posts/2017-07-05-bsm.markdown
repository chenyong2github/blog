---
layout:     post
title:      "用Unity实现基本Shadow Mapping"
date:       2017-07-05
author:     "ChenYong"
...
### 原理
基本的Shadow mapping由两个绘制过程构成。第一个过程，在光源处设置相机绘制场景，深度测试和写入打开，生成shadow map。第二个过程，正常绘制场景，把当前片段转换到光源空间，计算得到的深度与采样shadow map得到的深度比较大小，判断当前片段是否在阴影中。
